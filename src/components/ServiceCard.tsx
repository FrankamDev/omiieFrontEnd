...
export default function ServiceCard({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className="text-2xl font-bold text-white dark:text-zinc-950 mb-4 leading-tight">
        {title}
      </h3>

      {/* Description */}
      <p className="text-zinc-400 dark:text-zinc-500 flex-1 leading-relaxed mb-8">
        {desc}
      </p>
